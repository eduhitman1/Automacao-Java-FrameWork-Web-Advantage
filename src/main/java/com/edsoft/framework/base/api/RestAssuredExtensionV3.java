...
public class RestAssuredExtensionV3 {

	private RequestSpecBuilder builder = new RequestSpecBuilder();
	private String method;
	private String url;

	public RestAssuredExtensionV3(String uri, String method, String token) {
		// Formulate the API url
		this.url = "http://localhost:3000" + uri;
		this.method = method;
		// Assuming we are using only one type of token across the framework, else we
		// need to pass token as parameter to the constructor
		if (token != null)
